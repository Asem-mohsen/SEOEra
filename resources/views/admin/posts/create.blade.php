...
@section('sub-breadcrumb', 'Create Post')
                ...
                <div class="col-md-12">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea class="form-control form-control-solid @error('description') is-invalid @enderror" 
                                  id="description" name="description" rows="6" placeholder="Enter post description" required>{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" class="form-control form-control-solid @error('contact_phone') is-invalid @enderror" id="contact_phone" name="contact_phone" placeholder="Enter post contact phone" required value="{{ old('contact_phone') }}">
                        @error('contact_phone')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
